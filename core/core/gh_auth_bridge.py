...
class GhAuthBridge:
    token_env_keys: tuple[str, ...] = ("HOST_BRIDGE_GH_TOKEN", "GITHUB_API", "GITHUB_API_KEY", "GITHUB_TOKEN", "GH_TOKEN")
    ...
    def ensure_authenticated(self, mode: str, distrobox_bridge: DistroboxBridge, host_has_binary: callable) -> None:
        ...
        raise GhAuthBridgeError("gh is not authenticated and no token found in HOST_BRIDGE_GH_TOKEN/GITHUB_API/GITHUB_API_KEY/GITHUB_TOKEN/GH_TOKEN")
